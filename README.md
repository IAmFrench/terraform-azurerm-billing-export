...
| <a name="input_export_version"></a> [export\_version](#input\_export\_version) | Version of the billing export. Should be use with `export_type`.<br><br>Valid values are:<br>- `1.0r2` & `1.0` for `FOCUS`<br>- `2023-12-01-preview` for Cost and usage details (EA, MCA, MPA and CSP)<br>- `2019-11-01` for Cost and usage details (MOSA)<br><br>E.g.: `1.0r2`, `1.0`, `2023-12-01-preview`, `2019-11-01` | `string` | n/a | yes |
